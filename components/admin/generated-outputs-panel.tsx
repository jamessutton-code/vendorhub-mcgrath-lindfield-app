...
export function GeneratedOutputsPanel({ slug, content }: { slug: string; content: VendorOutputContent }) {
  return (
    <section style={cardStyle}>
      <div style={kickerStyle}>Generated Outputs</div>
      <h2 style={headingStyle}>AI Review Surface</h2>
      <p style={copyStyle}>
        This is now the practical approval and test layer for market briefs, auction commentary, comp reads, buyer feedback summaries, and projections.
      </p>

      <form action={saveVendorOutputsAction} style={{ display: 'grid', gap: 18 }}>
        <input type="hidden" name="slug" value={slug} />

        <OutputSection title="Latest Updates">
        ...
        <OutputSection title="Auction Updates">
        ...
        <OutputSection title="Market Competition">
        ...
        <OutputSection title="Buyer Feedback">
        ...
        <OutputSection title="Projections">
          <div style={gridStyle}>
        ...
        <div>
          <button type="submit" style={buttonStyle}>Save output content</button>
        </div>
      </form>
    </section>
  );
